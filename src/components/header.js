		...
		<HeaderContainer>
			<HeaderTop>
				...
				<HeaderNavList>
					...
					<HeaderNavLink href="https://beta.observablehq.com/@wcjohnson11" target="_blank" title="observable">
			...
			<Spring
				from={{ opacity: location.pathname === '/' ? 0 : 1, height: location.pathname === '/' ? 0 : 500 }}
